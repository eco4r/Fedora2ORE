...
/**
 * 
 * <b>Class Name</b>: DefaultFedoraConnector</br>
 * <b>Class Definition</b>:
 * <p> Is an default implementation of the {@link Connector} interface.
 * An instance of this class is a container that holds two Fedora-Connection Objects:
 * {@link FedoraClient} and {@link HTTPClient}.</p>  
 * 
...
public class DefaultFedoraConnector implements Connector{
	...
	public Connection connect() {
		try {
			...
			this.httpClient.getState().setCredentials(
	                new AuthScope(this.getHost(), Integer.parseInt(this.getPort())),
	                new UsernamePasswordCredentials(this.getUser(), this.getPasswd()));
	...
	private String getBaseURL(String host, String port, String fedoraServicePrefix){
		String baseURL = "http://" + host + ":" + port + "/" + fedoraServicePrefix;
		return baseURL;
	}
