 ...
 * HTTPClient object that is responsible for the communication through the HTTP</p>
 *
 * @author Anouar Boulal, boulal@hbz-nrw.de
 *
 */

public class RiConnector implements Connector{
...
private static Logger logger = Logger.getLogger(Connector.class);
	...
	public RiConnector(String configFile) {
