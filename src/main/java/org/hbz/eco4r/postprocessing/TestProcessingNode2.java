...
public class TestProcessingNode2 implements ProcessingNode {

	private static Logger logger = Logger.getLogger(TestProcessingNode2.class);
	...
	public ResourceMap run(ResourceMap rem) {
		logger.info(" ------------------------------------------------ ");
		logger.info("Performing Processing Node: " + TestProcessingNode2.class);
		...
		logger.info("Processing Node: " + TestProcessingNode2.class + " finished!");
		logger.info(" ------------------------------------------------ ");
